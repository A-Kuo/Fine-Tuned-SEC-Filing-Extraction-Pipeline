...
create index if not exists idx_extractions_filing_id on public.extractions (filing_id);
create index if not exists idx_extractions_ticker on public.extractions (ticker);
create index if not exists idx_extractions_filing_date on public.extractions (filing_date desc);
create index if not exists idx_extractions_model_version on public.extractions (model_version);
create index if not exists idx_extractions_parsed_output_gin on public.extractions using gin (parsed_output);
...
create index if not exists idx_extraction_logs_created_at on public.extraction_logs (created_at desc);
...
create index if not exists idx_ab_test_results_filing_id on public.ab_test_results (filing_id);
create index if not exists idx_ab_test_results_model_version on public.ab_test_results (model_version, created_at desc);
...
create index if not exists idx_pipeline_stages_stage on public.pipeline_stages (stage);