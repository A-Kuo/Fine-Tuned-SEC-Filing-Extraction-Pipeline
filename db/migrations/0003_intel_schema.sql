...
create index if not exists idx_intel_filing_sections_filing_id on intel.filing_sections (filing_id);
...
create index if not exists idx_intel_financial_metrics_filing_id on intel.financial_metrics (filing_id);
create index if not exists idx_intel_financial_metrics_name on intel.financial_metrics (metric_name);
...
create index if not exists idx_intel_risk_factors_filing_id on intel.risk_factors (filing_id);
...
create index if not exists idx_intel_extraction_runs_filing_id on intel.extraction_runs (filing_id);